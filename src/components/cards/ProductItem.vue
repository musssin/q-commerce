    ...
    >
      <div class="d-flex flex-no-wrap justify-space-between">
        <div>
          ...
          <v-card-subtitle style="color: rgb(200, 10, 10); opacity: 1"
            >{{ product?.price }} KZT</v-card-subtitle
          >
          <v-card-subtitle style="color: black; opacity: 1">{{
            product?.description
          }}</v-card-subtitle>
          ...
          <v-card-actions>
            ...
            />
            <v-btn
              v-show="newProduct?.balance != product?.balance"
              class="ms-2"
              variant="outlined"
              size="small"
              @click="updateProduct"
          ...
          <v-card-actions>
            <v-btn
              ...
              color="primary"
              :append-icon="
                showEdit ? 'mdi-arrow-up-bold' : 'mdi-arrow-down-bold'
              "
